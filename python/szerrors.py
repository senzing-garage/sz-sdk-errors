...
Generated date: 2024-04-01T15:12:24.414624+00:00
"""
...
EXCEPTION_MAP = {
    ...
    10: {SzRetryTimeoutExceededError},  # EAS_ERR_RETRY_TIMEOUT - Retry timeout exceeded
    ...
    25: {SzBadInputError},  # EAS_ERR_CONFLICTING_LOAD_ID_VALUES - Conflicting LOAD_ID values '{0}' and '{1}'
    ...
    45: {SzError},  # EAS_ERR_UMF_PROC_PROCESSING_FAILED - UMF procedure processing failed
    ...
    65: {SzBadInputError},  # EAS_ERR_UNKNOWN_ENTITY_TYPE_ID - Unknown entity type ID '{0}'
    ...
    79: {SzError},  # EAS_ERR_ERROR_WHEN_DECRYPTING - Error when decryting '{0}'
    ...
    90: {SzConfigurationError},  # EAS_ERR_CANNOT_ADD_LIBRARY_FEATURES_TO_DATASTORE - Cannot add library features to datastore
    ...
    2047: {SzConfigurationError},  # EAS_ERR_MISSING_DSRC_CODE - OBS_SRC_KEY[{0}] is missing DSRC_CODE tag which is required
    ...
    2057: {SzBadInputError},  # EAS_ERR_BAD_DSRC_ACTION - OBS_SRC_KEY[{0}] has DSRC_ACTION[{1}] which is invalid.  Valid values are [A]dd, [C]hange, [D]elete, [P]rune or E[X]tensive Evaluation
    ...
    2077: {SzConfigurationError},  # EAS_ERR_TABLE_CONFIGURED_WITH_INVALID_ETYPE_ID - Table {0} configured with an invalid type ETYPE_ID[{1}]
    ...
    2087: {SzConfigurationError},  # EAS_ERR_TABLE_CONFIGURED_WITH_DUPLICATE_CONFIG_FOR_EFU_TYPE - Table [{0}] configured with duplicate config values for ETYPE_ID[{1}]/FTYPE_ID[{2}]/UTYPE_CODE[{3}]
    ...
    2135: {SzConfigurationError},  # EAS_ERR_UMF_MAPPING_CONFIG_ERROR - Error in UMF Mapping Config[{0}]
    2136: {SzConfigurationError},  # EAS_ERR_UMF_MAPPING_MISSING_REQUIRED_FIELD - Error in UMF Mapping, missing required field[{0}]
    2137: {SzConfigurationError},  # EAS_ERR_UMF_MAPPING_MALFORMED_INPUT - Error in UMF Mapping, input message is malformed[{0}]
    ...
    2205: {SzConfigurationError},  # EAS_ERR_ENTITY_TYPE_CODE_ALREADY_EXISTS - Entity type code [{0}] already exists.
    2206: {SzConfigurationError},  # EAS_ERR_ENTITY_TYPE_ID_ALREADY_EXISTS - Entity type ID [{0}] already exists.
    2207: {SzConfigurationError},  # EAS_ERR_DATA_SOURCE_CODE_DOES_NOT_EXIST - Data source code [{0}] does not exist.
    2208: {SzConfigurationError},  # EAS_ERR_DATA_SOURCE_CODE_ALREADY_EXISTS - Data source code [{0}] already exists.
    ...
    2295: {SzError},  # EAS_ERR_ETYPE_CODE_DOES_NOT_EXIST - Entity type code [{0}] does not exist.
    ...
    7241: {SzConfigurationError},  # EAS_ERR_UNKNOWN_GPLAN_IN_TABLE - Unknown FTYPE_ID[{0}] referenced in {1}.
    ...
    9224: {SzConfigurationError},  # EAS_ERR_FTYPE_CONFIGURED_TO_BE_HASHED - A Feature Type is marked for hashing, but a valid salt value was not found.  FTYPE_ID[{0}] FTYPE_CODE[{1}]
    ...
    9284: {SzError},  # EAS_ERR_G2SS_INVALID_SLOT_ID - Can not obtain info on specified slot. Possibly invalid slot ID specified in Secure Store URL: {0}
    ...
    9703: {SzError},  # EAS_ERR_MEMTBL_COL_INDEX_TOO_BIG - Current field in memory row is passed end of row
