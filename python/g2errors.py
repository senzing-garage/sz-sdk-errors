...
Generated date: 2024-03-21T20:30:46.778615+00:00
"""
...
EXCEPTION_MAP = {
    ...
    5: {G2Error},  # EAS_ERR_EXCEEDED_MAX_RETRIES - Exceeded the Maximum Number of Retries Allowed
    ...
    29: {G2Error},  # EAS_ERR_INVALID_HANDLE - Invalid Handle
    ...
    38: {G2Error},  # EAS_ERR_RECORD_HAS_NO_RESOLVED_ENTITY - Data source record has no resolved entity: dsrc[{0}], recordID[{1}]
    39: {G2Error},  # EAS_ERR_NO_OBSERVED_ENTITY_FOR_DSRC_ENTITY_KEY - No observed entity for entity key: dsrc[{0}], record_id[{1}], key[{2}]
    40: {G2ConfigurationError},  # EAS_ERR_CONFIG_COMPATIBILITY_MISMATCH - The engine configuration compatibility version [{0}] does not match the version of the provided config[{1}].
    41: {G2Error},  # EAS_ERR_DOCUMENT_PREPROCESSING_FAILED - Document preprocessing failed
    42: {G2Error},  # EAS_ERR_DOCUMENT_LOAD_PROCESSING_FAILED - Document load processing failed
    43: {G2Error},  # EAS_ERR_DOCUMENT_ER_PROCESSING_FAILED - Document ER processing failed
    44: {G2Error},  # EAS_ERR_CHECK_ENTITY_PROCESSING_FAILED - Check entity processing failed
    45: {G2Error},  # EAS_ERR_UMF_PROC_PROCESSING_FAILED - UMF procedure processing failed
    46: {G2Error},  # EAS_ERR_DOCUMENT_HASHING_PROCESSING_FAILED - Document hashing-processing failed
    47: {G2Error},  # EAS_ERR_SESSION_IS_INVALID - Session is invalid
    ...
    52: {G2Error},  # EAS_ERR_UNKNOWN_RELATIONSHIP_ID_VALUE - Unknown relationship ID value '{0}'
    ...
    55: {G2Error},  # EAS_ERR_NO_RESOLVED_ENTITY_FOR_DSRC_ENTITY_KEY - No resolved entity for entity key: dsrc[{0}], record_id[{1}], key[{2}]
    56: {G2Error},  # EAS_ERR_NO_RECORDS_EXIST_FOR_RESOLVED_ENTITY - No data source records exist for entity ID: entityID[{0}]
    57: {G2Error},  # EAS_ERR_UNKNOWN_FEATURE_ID_VALUE - Unknown feature ID value '{0}'
    58: {G2Error},  # EAS_ERR_G2_INITIALIZATION_FAILURE - G2 initialization process has failed
    60: {G2ConfigurationError},  # EAS_ERR_CONFIG_DATABASE_MISMATCH - The engine configuration does not match the records loaded into the repository:  errors[{0}].
    ...
    67: {G2ConfigurationError},  # EAS_ERR_INVALID_GENERIC_PLAN_VALUE - Invalid Generic Plan ID [{0}] configured for the '{1}' retention level.'
    68: {G2Error},  # EAS_ERR_UNKNOWN_ER_RESULT - Unknown ER-result.
    69: {G2Error},  # EAS_ERR_NO_CANDIDATES - No candidates.
    76: {G2Error},  # EAS_ERR_INBOUND_FEATURE_VERSION_NEWER_THAN_CONFIG - Inbound Feature Version [{0}] is newer than configured version [{1}] for feature type[{2}].
    77: {G2Error},  # EAS_ERR_ERROR_WHEN_PRIMING_GNR - Error when priming GNR resources '{0}'
    78: {G2Error},  # EAS_ERR_ERROR_WHEN_ENCRYPTING - Error when encrypting '{0}'
    79: {G2Error},  # EAS_ERR_ERROR_WHEN_DECRYPTING - Error when decryting '{0}'
    80: {G2Error},  # EAS_ERR_ERROR_WHEN_VALIDATING_ENCRYPTION_SIGNATURE_COMPATIBILITY - Error when validating encryption signature compatibility '{0}'
    81: {G2Error},  # EAS_ERR_ERROR_WHEN_CHECKING_DISTINCT_FEATURE_GENERALIZATION - Error when checking distinct feature generalization '{0}'
    82: {G2Error},  # EAS_ERR_ERROR_WHEN_RUNNING_DQM - Error when running DQM '{0}'
    83: {G2Error},  # EAS_ERR_ERROR_WHEN_CREATING_EFEATS - Error when creating EFEATS '{0}'
    84: {G2Error},  # EAS_ERR_ERROR_WHEN_SIMPLE_SCORING - Error when simple scoring '{0}'
    85: {G2Error},  # EAS_ERR_ERROR_WHEN_SCORING_PAIR - Error when scoring a pair '{0}'
    86: {G2Error},  # EAS_ERR_ERROR_WHEN_SCORING_SET - Error when scoring a set '{0}'
    ...
    2002: {G2Error},  # EAS_ERR_REQUESTED_CONFIG_FOR_INVALID_FTYPE_CODE - Requested config for invalid FTYPE_CODE[{0}]
    2003: {G2Error},  # EAS_ERR_NO_FELEM_CODE - Cannot process OBS_FELEM with no FELEM_CODE[{0}]
    2005: {G2Error},  # EAS_ERR_INVALID_FELEM_CODE - FELEM_CODE[{0}] is not configured for FTYPE_CODE[{1}]
    2006: {G2Error},  # EAS_ERR_MISSING_ENT_SRC_KEY - OBS_ENT is missing ENT_SRC_KEY
    2007: {G2Error},  # EAS_ERR_MISSING_OBS_SRC_KEY - OBS is missing OBS_SRC_KEY
    ...
    2027: {G2Error},  # EAS_ERR_PLUGIN_INIT - Plugin initialization error {0}
    2029: {G2ConfigurationError},  # EAS_ERR_REQUESTED_CONFIG_FOR_INVALID_PLUGIN - Configuration not found for plugin type: {0}
    2034: {G2ConfigurationError},  # EAS_ERR_INVALID_CFRTN_VAL - CFRTN_ID[{0}]/FTYPE[{1}] is expecting CFRTN_VAL[{2}] which is not offered by CFUNC_ID[{3}][{4}]. Available scores are [{5}]
    2036: {G2ConfigurationError},  # EAS_ERR_FTYPE_HAS_NO_BOM - FType configured with no Feature Elements (Bill of Materials)  FTYPE_ID[{0}] FTYPE_CODE[{1}]
    2037: {G2ConfigurationError},  # EAS_ERR_FUNC_CALL_HAS_NO_BOM - Function call ({3}) configured with no Bill of Materials  {4}[{0}] FTYPE_ID[{1}] FTYPE_CODE[{2}]
    2038: {G2ConfigurationError},  # EAS_ERR_DISTINCT_FEATURE_HAS_NO_BOM - Distinct feature call configured with no Bill of Materials  DFCALL_ID[{0}]
    2041: {G2ConfigurationError},  # EAS_ERR_EFCALL_HAS_NO_BOM - EFeature creation call configured with no Bill of Materials  EFCALL_ID[{0}]
    ...
    2048: {G2ConfigurationError},  # EAS_ERR_FEAT_FREQ_INVALID - FEATURE CODE[{0}] FEATURE FREQUENCY[{1}] is an invalid frequency
    ...
    2057: {G2BadInputError},  # EAS_ERR_BAD_DSRC_ACTION - OBS_SRC_KEY[{0}] has DSRC_ACTION[{1}] which is invalid.  Valid values are [A]dd, [C]hange, [D]elete, [P]rune or E[X]tensive Evaluation
    2061: {G2ConfigurationError},  # EAS_ERR_DUPLICATE_LOOKUP_IDENTIFIER - Duplicate [{0}] with identifier value [{1}].  Only unique values are allowed.
    2062: {G2ConfigurationError},  # EAS_ERR_INVALID_LOOKUP_IDENTIFIER - Requested lookup of [{0}] using unknown value [{1}].  Value not found.
    2065: {G2ConfigurationError},  # EAS_ERR_FTYPE_HAS_MULTIPLE_DEFINITIONS - FType configured with multiple definitions. FTYPE_CODE[{0}] used in FTYPE_ID[{1}] and FTYPE_ID[{2}]
    2066: {G2ConfigurationError},  # EAS_ERR_FELEM_HAS_MULTIPLE_DEFINITIONS - FElem configured with multiple definitions. FELEM_CODE[{0}] used in FELEM_ID[{1}] and FELEM_ID[{2}]
    2067: {G2ConfigurationError},  # EAS_ERR_ERFRAG_HAS_MULTIPLE_DEFINITIONS - ER Fragment code configured with multiple definitions. ERFRAG_CODE[{0}] used in ERFRAG_ID[{1}] and ERFRAG_ID[{2}]
    2069: {G2ConfigurationError},  # EAS_ERR_BOM_CONFIG_INVALID_FOR_SIMPLE_PLUGIN - Configured plugin for CFCALL_ID[{0}] requires exactly one value in BOM
    2070: {G2ConfigurationError},  # EAS_ERR_EFCALL_HAS_INVALID_FUNCTION - EFeature creation call configured with invalid function ID EFCALL_ID[{0}] EFUNC_ID[{1}]
    2071: {G2ConfigurationError},  # EAS_ERR_EFBOM_HAS_INVALID_EFCALL - EFeature BOM configured with invalid EFCALL_ID[{0}]
    2073: {G2Error},  # EAS_ERR_LOADING_LIBRARY - Library loading error {0}
    2074: {G2Error},  # EAS_ERR_SCORING_MANAGER_PLUGIN - Scoring manager: id {0} and {1} do not match
    ...
    2087: {G2ConfigurationError},  # EAS_ERR_TABLE_CONFIGURED_WITH_DUPLICATE_CONFIG_FOR_EFU_TYPE - Table [{0}] configured with duplicate config values for ETYPE_ID[{1}]/FTYPE_ID[{2}]/UTYPE_CODE[{3}]
    ...
    2090: {G2ConfigurationError},  # EAS_ERR_SFCALL_HAS_INVALID_FUNCTION - Feature standardization call configured with invalid function ID SFCALL_ID[{0}] SFUNC_ID[{1}]
    ...
    2093: {G2ConfigurationError},  # EAS_ERR_TABLE_CONFIGURED_WITH_DUPLICATE_EXEC_ORDER_FOR_IDENTIFIER_LIST - Table [{0}] configured with duplicate execution order value [{3}] for identifiers[{1}] with values [{2}]
    2094: {G2ConfigurationError},  # EAS_ERR_DUPLICATE_VALUE_FOR_FIELD_IN_TABLE - Duplicate value [{2}] of field [{1}] in config [{0}]
    2095: {G2ConfigurationError},  # EAS_ERR_TABLE_CONFIGURED_WITH_INVALID_FTYPE_CODE_FELEM_CODE_PAIR - Table {0} configured with an invalid FTYPE_CODE[{1}]/FELEM_CODE[{2}] pair
    2099: {G2ConfigurationError},  # EAS_ERR_COUNTER_CONFIG_INVALID_THRESHOLD - Next Threshold for a counter should be no less than 10, but has NEXT_THRESH{0}
    ...
    2116: {G2Error},  # EAS_ERR_UNITIALIZED_AMBIGUOUS_CACHE - Uninitialized Ambiguous Test Cache
    2117: {G2ConfigurationError},  # EAS_ERR_SCORING_CALL_HAS_NO_BOM - Scoring call configured with no Bill of Materials  CFCALL_ID[{0}].
    ...
    2123: {G2ConfigurationError},  # EAS_ERR_CFUNC_CONFIGURED_WITH_NO_CFRTN - CFG_CFUNC [{0}] feature type [{1}] configured without any corresponding return values in CFG_CFRTN
    2131: {G2ConfigurationError},  # EAS_ERR_OBS_ENT_NOT_FOUND - Requested resolution of OBS_ENT_ID that is not loaded OBS_ENT_ID[{0}]
    ...
    2139: {G2ConfigurationError},  # EAS_ERR_DSRC_INTEREST_CONFIGURED_WITH_INVALID_DSRCID - Data Source Interest configured with invalid Data Source ID DSRC_ID[{0}]
    ...
    2213: {G2ConfigurationError},  # EAS_ERR_INVALID_FELEM_DATA_TYPE - Invalid feature element datatype [{0}] found.  Datatype must be in [{1}].
    2214: {G2ConfigurationError},  # EAS_ERR_FELEM_IS_CONFIGURED_FOR_USE_IN_FEATURES - Feature element [{0}] is configured for use in feature(s) [{1}].
    ...
    2221: {G2ConfigurationError},  # EAS_ERR_FUNCTION_USES_BOTH_FTYPE_AND_FELEM_TRIGGER - Function call requested uses both triggering feature type [{0}] and triggering feature element code [{1}].  Cannot use both triggering feature type and triggering feature element code.
    ...
    2230: {G2ConfigurationError},  # EAS_ERR_FTYPE_CODE_AND_FELEM_CODE_MUST_BE_UNIQUE_IN_EXPRESSED_FUNCTION_CALL - Feature type [{0}] and feature element [{1}] must be unique in expressed feature function call.
    2231: {G2ConfigurationError},  # EAS_ERR_FTYPE_CODE_AND_FELEM_CODE_IN_EXPRESSED_FUNCTION_CALL_DO_NOT_EXIST_IN_FEATURE - Feature type [{0}] and feature element [{1}] requested for expressed feature function call, but don't exist in feature [{0}].
    2232: {G2ConfigurationError},  # EAS_ERR_FELEM_CODE_MUST_BE_UNIQUE_IN_COMPARISON_FUNCTION_CALL - Feature element [{0}] must be unique in comparison feature function call.
    2233: {G2ConfigurationError},  # EAS_ERR_FELEM_CODE_IN_COMPARISON_FUNCTION_CALL_DOES_NOT_EXIST_IN_FEATURE - Feature element [{0}] requested for comparison feature function call, but doesn't exist in feature [{1}].
    2234: {G2ConfigurationError},  # EAS_ERR_FELEM_CODE_MUST_BE_UNIQUE_IN_DISTINCT_FUNCTION_CALL - Feature element [{0}] must be unique in distinct feature function call.
    2235: {G2ConfigurationError},  # EAS_ERR_FELEM_CODE_IN_DISTINCT_FUNCTION_CALL_DOES_NOT_EXIST_IN_FEATURE - Feature element [{0}] requested for distinct feature function call, but doesn't exist in feature [{1}].
    ...
    2241: {G2ConfigurationError},  # EAS_ERR_FTYPE_CODE_REQUIRED_BY_SEPARATE_EXPRESSED_FUNCTION_CALL - Feature type [{0}] required for separate expressed feature function call [{1}].
    ...
    2248: {G2ConfigurationError},  # EAS_ERR_DISTINCT_FUNCTION_CALL_DOES_NOT_EXIST_FOR_FEATURE - Distinct feature function call does not exist for feature [{0}].
    2249: {G2ConfigurationError},  # EAS_ERR_CONFLICTING_SPECIFIERS_FOR_FUNCTION_CALL - Conflicting specifiers: Function call ID [{0}] does not match function call ID [{1}] from feature type.
    ...
    2254: {G2ConfigurationError},  # EAS_ERR_FUNCTION_USES_NEITHER_FTYPE_NOR_FELEM_TRIGGER - Function call requested uses neither triggering feature type [{0}] nor triggering feature element code [{1}].  At least one trigger must be specified.
    ...
    2281: {G2ConfigurationError},  # EAS_ERR_CFRTN_VALUE_ALREADY_EXISTS - Feature comparison function return value [{0}] already exists for comparison function [{1}] ftype [{2}].
    2282: {G2ConfigurationError},  # EAS_ERR_CFUNC_EXEC_ORDER_ALREADY_EXISTS - Feature comparison function exec order value [{0}] already exists for comparison function [{1}] ftype [{2}].
    2283: {G2ConfigurationError},  # EAS_ERR_EFUNC_CODE_DOES_NOT_EXIST - Feature expression function code [{0}] does not exist.
    2285: {G2Error},  # EAS_ERR_INVALID_FORMAT_FOR_ENTITIES - Invalid format for ENTITIES.
    2286: {G2Error},  # EAS_ERR_NO_ENTITY_ID_FOUND_FOR_ENTITY - No entity ID found for entity.
    2287: {G2Error},  # EAS_ERR_NO_DATA_SOURCE_FOUND - No data source found.
    2288: {G2Error},  # EAS_ERR_NO_RECORD_ID_FOUND - No record ID found.
    ...
    2291: {G2ConfigurationError},  # EAS_ERR_FRAGMENT_IS_CONFIGURED_FOR_USE_IN_FRAGMENT - Rule fragment [{0}] is configured for use in fragments(s) [{1}].
    2292: {G2Error},  # EAS_ERR_CANT_RETRIEVE_OBS_FEATURE_DATA_FOR_OBS_ENT - Could not retrieve observed feature data for observed entity [{0}].
    2293: {G2Error},  # EAS_ERR_NO_RECORDS_SPECIFIED - No records specified.
    2294: {G2Error},  # EAS_ERR_DATA_SOURCE_ID_DOES_NOT_EXIST - Data source ID [{0}] does not exist.
    2295: {G2Error},  # EAS_ERR_ETYPE_CODE_DOES_NOT_EXIST - Entity type code [{0}] does not exist.
    7209: {G2ConfigurationError},  # EAS_ERR_DB_BAD_BACKEND_TYPE - Invalid [SQL] Backend Parameter. Valid values are SQL or HYBRID
    7211: {G2ConfigurationError},  # EAS_ERR_DB_BAD_CLUSTER_SIZE - Cluster [{0}] is configured with an invalid size. Size must be equal to 1.
    ...
    7220: {G2ConfigurationError},  # EAS_ERR_NO_CONFIG_REGISTERED_IN_DATASTORE - No engine configuration registered in datastore (see https:#senzing.zendesk.com/hc/en-us/articles/360036587313).
    7221: {G2ConfigurationError},  # EAS_ERR_NO_CONFIG_REGISTERED_FOR_DATA_ID - No engine configuration registered with data ID [{0}].
    7222: {G2Error},  # EAS_ERR_FAILED_TO_SET_SYS_VAR_IN_DATASTORE - Could not set system variable value in database for Group[{0}],Code[{1}],Value[{2}].
    ...
    7226: {G2ConfigurationError},  # EAS_ERR_INCOMPATIBLE_DATASTORE_SCHEMA_VERSION - Incompatible datastore schema version: [Engine version '{0}'.  Datastore version '{1}' is installed, but must be between '{2}' and '{3}'.]
    ...
    7235: {G2ConfigurationError},  # EAS_ERR_FTYPE_CONFIGURED_AS_REL_BUT_NO_RTYPE - FTYPE_CODE[{0}] IS CONFIGURED AS A RELATIONSHIP FEATURE TYPE BUT RTYPE_ID IS NOT SET.
    7236: {G2ConfigurationError},  # EAS_ERR_DUPLICATE_BEHAVIOR_OVERRIDE_KEY_IN_CFG_FBOVR - Duplicate behavior override keys in CFG_FBOVR -- FTYPE_ID[{0}], UTYPE_CODE[{1}] referenced in CFG_FBOVR.
    7237: {G2ConfigurationError},  # EAS_ERR_UNKNOWN_FTYPE_IN_TABLE - Unknown FTYPE_ID[{0}] referenced in {1}.
    7239: {G2ConfigurationError},  # EAS_ERR_INVALID_GENERIC_THRESHOLD_CANDIDATE_CAP - Invalid generic threshold {0} cap [{1}] for [GPLAN_ID[{2}], BEHAVIOR[{3}], FTYPE_ID[{4}]].
    7240: {G2ConfigurationError},  # EAS_ERR_INCORRECT_BEHAVIOR_REFERENCED - Incorrect BEHAVIOR[{0}] referenced in CFG_GENERIC_THRESHOLD for [GPLAN_ID[{1}], FTYPE_ID[{2}]].  FType configured for behavior [{3}]
    7241: {G2ConfigurationError},  # EAS_ERR_UNKNOWN_GPLAN_IN_TABLE - Unknown FTYPE_ID[{0}] referenced in {1}.
    7242: {G2ConfigurationError},  # EAS_ERR_MULTIPLE_GENERIC_THRESHOLD_DEFINITIONS - Multiple Generic Threshold definitions for [GPLAN_ID[{0}], BEHAVIOR[{1}], FTYPE_ID[{2}]].
    7243: {G2ConfigurationError},  # EAS_ERR_ER_FRAGMENT_HAS_UNDEFINED_DEPENDENT_FRAGMENTS - ER Fragment [{0}] configured with undefined dependent fragments. Fragment [{1}] undefined.
    ...
    7245: {G2ConfigurationError},  # EAS_ERR_CURRENT_CONFIG_REGISTERED_DOES_NOT_MATCH_DATA_ID - Current configuration ID does not match specified data ID [{0}].
    7246: {G2ConfigurationError},  # EAS_ERR_INVALID_MAXIMUM_DATASTORE_SCHEMA_VERSION - Invalid maximum datastore version number for engine schema [version '{0}'].
    7247: {G2ConfigurationError},  # EAS_ERR_INVALID_MINIMUM_DATASTORE_SCHEMA_VERSION - Invalid minimum datastore version number for engine schema [version '{0}'].
    ...
    7511: {G2Error},  # EAS_ERR_ABORT_ER_AND_RETRY - Detected change in candidate entity[{0}].  Restarting ER evaluation.
    8000: {G2BadInputError},  # EAS_ERR_GNRNP - GNR NameParser Failure
    8410: {G2Error},  # EAS_ERR_UNINITIALIZED_AMBIGUOUS_FEATURE - Cannot use uninitialized ambiguous feature.
    8501: {G2ConfigurationError},  # EAS_ERR_SALT_DIGEST_ALGORITHM_NOT_AVAILABLE - Failed to get {0} digest algorithm from ICC.
    8502: {G2Error},  # EAS_ERR_SALT_DIGEST_CONTEXT_CREATE_FAILED - Failed to create a digest context.
    8503: {G2Error},  # EAS_ERR_SALT_DIGEST_CONTEXT_INIT_FAILED - Failed {0} to initialise a digest context.
    8504: {G2Error},  # EAS_ERR_SALT_DIGEST_FAILED - Failed {0} to digest block {1}.
    8505: {G2Error},  # EAS_ERR_SALT_DIGEST_FINAL_FAILED - Failed {0} to complete digest.
    8508: {G2Error},  # EAS_ERR_SALT_DIGEST_UNKNOWN_EXCEPTION - Unrecognized exception thrown generating digest.
    8509: {G2Error},  # EAS_ERR_SALT_DIGEST_ALGORITHM_REQUIRED - Cannot generate a digest without a valid algorithm.
    8514: {G2Error},  # EAS_ERR_SALT_RANDOM_FAILED - Failed {0} to get random content
    8516: {G2ConfigurationError},  # EAS_ERR_SALT_MUST_BE_SIZE - A salt value must be {0} bytes long but the provided one is {1} bytes.
    8517: {G2ConfigurationError},  # EAS_ERR_SALT_DOES_NOT_MATCH_CHECKSUM - The salt value does not match the recorded checksum.
    8520: {G2Error},  # EAS_ERR_SALT_G2SS_INIT_FAILED - Secure Store initialization failed.
    8521: {G2Error},  # EAS_ERR_SALT_G2SS_TOKEN_MUST_BE_INIT - Hashing with a named salt requires the Secure Store to be initialised.
    8522: {G2ConfigurationError},  # EAS_ERR_SALT_G2SS_SOPIN_NOT_VALID - The Security Officer (SO) PIN is not correct.
    8524: {G2Error},  # EAS_ERR_SALT_G2SS_INIT_UNKNOWN_EXCEPTION - Secure Store initialization failed with an unrecognised exception
    ...
    8530: {G2Error},  # EAS_ERR_SALT_CANNOT_OVERWRITE - You cannot overwrite an existing salt called {0}
    ...
    8539: {G2Error},  # EAS_ERR_SALT_G2SS_ERROR_CHANGING_METHOD - Secure Store error changing hashing method
    8540: {G2ConfigurationError},  # EAS_ERR_SALT_WRONG_SIZE - The object called {0} is not a salt
    8541: {G2Error},  # EAS_ERR_SALT_BASE64_DECODE_ERROR - Base64 decoding error in salt {0} at character {1}
    8542: {G2Error},  # EAS_ERR_SALT_UNINITIALISED - Must load a salt before using it.
    ...
    8557: {G2ConfigurationError},  # EAS_ERR_SALT_METHOD_DOES_NOT_MATCH - The hashing method in the configuration ({1}) does not match the method ({2}) of the salt {0}
    8593: {G2Error},  # EAS_ERR_SALT_HMAC_CONTEXT_INIT_FAILED - Failed {0} to initialise an HMAC context.
    8594: {G2Error},  # EAS_ERR_SALT_HMAC_FAILED - Failed {0} to HMAC block {1}.
    8595: {G2Error},  # EAS_ERR_SALT_HMAC_FINAL_FAILED - Failed {0} to complete HMAC.
    8598: {G2Error},  # EAS_ERR_SALT_HMAC_UNKNOWN_EXCEPTION - Unrecognized exception thrown generating HMAC.
    ...
    8602: {G2ConfigurationError},  # EAS_ERR_HASHER_CHECKSUM_DOES_NOT_MATCH - The hashing checksum configured ({1}) does not match the checksum ({2}) of the salt named {0}
    8603: {G2Error},  # EAS_ERR_HASHER_UNABLE_TO_RECORD_SALT - Unable to record the configured salt
    ...
    8607: {G2ConfigurationError},  # EAS_ERR_HASHER_INVALID_ARGS - Invalid arguments to hashing function. Either a parameter wasn't provided or a buffer was too small: location={0}, dataPtr={1}, dataLength={2}, outputPtr={3}, outputLength={4}, output={5}
    ...
    9111: {G2ConfigurationError},  # EAS_ERR_PARSE_FRAGMENT - ERROR parsing FragmentID[{0}] FragmentName[{1}] : [{2}] is an invalid RuleID dependency
    ...
    9220: {G2ConfigurationError},  # EAS_ERR_FTYPE_CANNOT_BE_HASHED - FType configured to be hashed, but cannot be scored.  FTYPE_ID[{0}] FTYPE_CODE[{1}]
    9222: {G2ConfigurationError},  # EAS_ERR_FTYPE_CONFIGURED_TO_BE_HASHED_MISSING_SALT - A Feature Type is marked for hashing, but a valid salt value was not found.  FTYPE_ID[{0}] FTYPE_CODE[{1}]
    9224: {G2ConfigurationError},  # EAS_ERR_FTYPE_CONFIGURED_TO_BE_HASHED - A Feature Type is marked for hashing, but a valid salt value was not found.  FTYPE_ID[{0}] FTYPE_CODE[{1}]
    9228: {G2ConfigurationError},  # EAS_ERR_UNEXPECTED_SALT_CHECKUM_LIST - The SALT checksum on the Observation does not match the EXPECTED SALT checksum: EXPECTED=[{0}] Observation=[{1}]
    ...
    9267: {G2Error},  # EAS_ERR_G2SS_UNABLE_TO_CREATE_KEY - Secure Store key creation failed.
    9268: {G2Error},  # EAS_ERR_G2SS_UNABLE_TO_CHANGE_PIN - Secure Store password change failed: {0}.
    ...
    9271: {G2Error},  # EAS_ERR_G2SS_OUT_OF_MEMORY - Secure Store out of memory.
    9272: {G2Error},  # EAS_ERR_G2SS_FIND_INIT_FAILED - Secure Store object locating failed: {0}.
    9273: {G2Error},  # EAS_ERR_G2SS_FIND_FAILED - Secure Store object find failed: {0}.
    9274: {G2Error},  # EAS_ERR_G2SS_CRYPTO_SETUP_FAILED - Secure Store setup of encryption failed: {0}.
    9275: {G2Error},  # EAS_ERR_G2SS_ENCRYPT_START_FAILED - Secure Store unable to start encryption: {0}.
    9276: {G2Error},  # EAS_ERR_G2SS_ENCRYPT_SIZE_FAILED - Secure Store unable to get the size of encrypted data: {0}.
    9277: {G2Error},  # EAS_ERR_G2SS_ENCRYPT_FAILED - Secure Store encryption failed: {0}.
    9278: {G2Error},  # EAS_ERR_G2SS_DECRYPT_START_FAILED - Secure Store unable to start decryption: {0}.
    9279: {G2Error},  # EAS_ERR_G2SS_DECRYPT_FAILED - Secure Store decryption failed: {0}.
    9280: {G2Error},  # EAS_ERR_G2SS_OBJECT_SAVE_FAILED - Secure Store unable to save object: {0}.
    9281: {G2Error},  # EAS_ERR_G2SS_OBJECT_DELETE_FAILED - Secure Store unable to delete object: {0}.
    9282: {G2Error},  # EAS_ERR_G2SS_OBJECT_CHANGE_FAILED - Secure Store unable to modify object: {0}.
    9283: {G2Error},  # EAS_ERR_G2SS_UNINITIALISED - Secure Store has not been initialized
    9284: {G2Error},  # EAS_ERR_G2SS_INVALID_SLOT_ID - Can not obtain info on specified slot. Possibly invalid slot ID specified in Secure Store URL: {0}
    9285: {G2ConfigurationError},  # EAS_ERR_G2SS_NO_TOKEN_IN_SLOT - No security token present in slot specified by Secure Store URL: slot ID = {0}
    9286: {G2ConfigurationError},  # EAS_ERR_G2SS_TOKEN_NOT_FOUND - Can not obtain info for security token. Possibly invalid token label and/or slot ID specified in Secure Store URL: {0}
    9287: {G2Error},  # EAS_ERR_G2SS_TOKEN_IMPL_ERROR - An internal error occurred in the security token implementation library: Return Code = {0}
    9288: {G2Error},  # EAS_ERR_G2SS_USER_PIN_PROMPT_FAILED - Was unable to prompt user for security token authentication.
    9289: {G2Error},  # EAS_ERR_G2SS_LABEL_CHANGED_SINCE_CONFIG_INIT - Secure Store has been reconfigured since loading.
    9290: {G2Error},  # EAS_ERR_G2SS_OBJECT_NOT_FOUND - Secure Store does not have an object called {0}.
    9292: {G2ConfigurationError},  # EAS_ERR_G2SS_NO_PASSWORD - No password supplied
    9293: {G2ConfigurationError},  # EAS_ERR_G2SS_NO_SEC_STORE_PREFIX - Secure Store expects a different format (starting with {0}) when a password is supplied
    ...
    9299: {G2Error},  # EAS_ERR_G2SS_CLASS_NOT_INIT - Secure Store internal error.
    ...
    9305: {G2Error},  # EAS_ERR_SEQUENCE_RETRIES_FAILED - Retries failed to retrieve Sequence Entry[{0}] in the SYS_SEQUENCE table!  This may mean the CACHE_SIZE is too small.
    ...
    9311: {G2Error},  # EAS_ERR_COULD_NOT_RECORD_USAGE_TYPE - Could not record usage type [{0}] in the LIB_UTYPE table!
    9406: {G2Error},  # EAS_ERR_G2SS_SESSION_MUST_NOT_BE_OPEN - Secure Store cannot fetch a value with sync if a session is already open.
    ...
    9410: {G2Error},  # EAS_ERR_G2SS_PKCS_INIT_FAILED - Initializing token driver failed {0}
    9411: {G2Error},  # EAS_ERR_G2SS_PKCS_FINAL_FAILED - Finalizing token driver failed {0}
    ...
    9500: {G2ConfigurationError},  # EAS_ERR_TOKEN_LIBRARY_CHECKSUM_MISMATCH - Cannot load token library. The checksum does not match the configuration of this node. Found: [{0}] Expected: [{1}]
    9701: {G2Error},  # EAS_ERR_CANT_RETRIEVE_INDEX_FROM_MEMORY_ROW - Cannot retrieve index[{0}] from memory row of key[{1}], out of range!
    9703: {G2Error},  # EAS_ERR_MEMTBL_COL_INDEX_TOO_BIG - Current field in memory row is passed end of row
    9802: {G2ConfigurationError},  # EAS_ERR_INBOUND_OBS_CONFIG_CHECKSUM_MISMATCH - Configuration checksum on inbound observation [{0}] does not match this nodes configuration checksum [{1}]. Cannot process.
    9803: {G2ConfigurationError},  # EAS_ERR_CALC_CONFIGCHKSUM_AND_PARAMSTORE_CONFIGCHKSUM_DONT_MATCH - The calculated configuration checksum [{0}] does not match the CONFIGURATION_CHECKSUM value in the parameter store [{1}].
    30011: {G2Error},  # EAS_ERR_DELETE_WITH_RESOLVE_ONLY - Cannot delete an entity with type RESOLVE_ONLY
    30101: {G2Error},  # EAS_ERR_INVALID_SESSION_HANDLE - Invalid Session Handle [{0}]
    30102: {G2Error},  # EAS_ERR_INVALID_REPORT_HANDLE - Invalid Report Handle [{0}]
    30103: {G2Error},  # EAS_ERR_INVALID_EXPORT_HANDLE - Invalid Export Handle [{0}]
    30110: {G2Error},  # EAS_ERR_RESPONSE_MESSAGE_SIZE_LARGER_THAN_BUFFER_SIZE - Response message size [{0}] is larger than buffer size [{1}]
    30111: {G2Error},  # EAS_ERR_RESPONSE_RESIZE_FUNCTION_IS_NOT_PROVIDED - Resize function is not provided
    30112: {G2Error},  # EAS_ERR_RESPONSE_RESIZE_FUNCTION_GAVE_INVALID_RESULT - Resize function returned an invalid result
