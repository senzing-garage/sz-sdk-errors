...
final class SzExceptionMapper {
    ...
    public static void registerExceptions(Map<Integer, Class<? extends SzException>> map) {
        ...
        map.put(5, SzException.class);                         // EAS_ERR_EXCEEDED_MAX_RETRIES                                                          "Exceeded the Maximum Number of Retries Allowed"
        map.put(7, SzBadInputException.class);                 // EAS_ERR_EMPTY_MESSAGE                                                                 "Empty Message"
        map.put(10, SzRetryTimeoutExceededException.class);    // EAS_ERR_RETRY_TIMEOUT                                                                 "Retry timeout exceeded resolved entity locklist [{0}]"
        ...
        map.put(18, SzException.class);                        // EAS_ERR_COULD_NOT_PROCESS_INITIALIZATION_SETTINGS                                     "Could not process initialization settings"
        ...
        map.put(48, SzNotInitializedException.class);          // EAS_ERR_SZ_NOT_INITIALIZED                                                            "SDK is not initialized"
        map.put(49, SzNotInitializedException.class);          // EAS_ERR_SZCORE_ALREADY_INITIALIZED                                                    "SzCore is already initialized - call SzCore::destroy() first"
        map.put(50, SzNotInitializedException.class);          // EAS_ERR_SZCORE_NOT_INITIALIZED                                                        "SzCore is not initialized - call SzCore::init() first"
        ...
        map.put(53, SzNotInitializedException.class);          // EAS_ERR_RECORD_ID_REQUIRED                                                            "RECORD_ID must be provided"
        map.put(54, SzDatabaseException.class);                // EAS_ERR_SZ_DATA_REPOSITORY_WAS_PURGED                                                 "Data repository was purged"
        ...
        map.put(58, SzException.class);                        // EAS_ERR_SZ_INITIALIZATION_FAILURE                                                     "Sz initialization process has failed"
        ...
        map.put(61, SzConfigurationException.class);           // EAS_ERR_AMBIGUOUS_SUPPRESSED_LIBFEAT_FELEM_MISSING                                    "AMBIGUOUS_SUPPRESSED_LIBFEAT Feature Element is not configured"
        ...
        map.put(87, SzUnhandledException.class);               // EAS_ERR_SZ_EXCEPTION                                                                  "Sz Exception '{0}'"
        ...
        map.put(93, SzException.class);                        // EAS_ERR_CONFUSED_ENTITY_FELEM_MISSING                                                 "YESNO_FLAG Feature Element is not configured"
        map.put(94, SzException.class);                        // EAS_ERR_DOMAIN_NAME_FELEM_MISSING                                                     "DOMAIN_NAME Feature Element is not configured"
        map.put(95, SzException.class);                        // EAS_ERR_SUPPRESSED_RELATIONSHIP_FTYPE_ID_FELEM_MISSING                                "SUPPRESSED_RELATIONSHIP_FTYPE_ID Feature Element is not configured"
        map.put(96, SzException.class);                        // EAS_ERR_SUPPRESSED_RELATIONSHIP_CONNECTING_FTYPE_ID_FELEM_MISSING                     "SUPPRESSED_RELATIONSHIP_CONNECTING_FTYPE_ID Feature Element is not configured"
        map.put(97, SzException.class);                        // EAS_ERR_ORPHANED_ENTITY_FTYPE_MISSING                                                 "ORPHANED_ENTITY Feature Type is not configured"
        map.put(98, SzException.class);                        // EAS_ERR_ORPHANED_ENTITY_FELEM_MISSING                                                 "VALUE Feature Element is not configured"
        map.put(999, SzLicenseException.class);                // EAS_ERR_LICENSE_HAS_EXPIRED                                                           "License has expired. {0}"
        ...
        map.put(2114, SzConfigurationException.class);         // EAS_ERR_INVALID_FTYPE_SCORESET                                                        "Cannot set score for invalid feature type ID [{0}]"
        ...
        map.put(2124, SzException.class);                      // EAS_ERR_FEATURE_CONFIGURED_WITH_ONLY_DERIVED_FELEMS                                   "Feature [{0}] configured with only derived felems"
        map.put(2131, SzConfigurationException.class);         // EAS_ERR_OBS_ENT_NOT_FOUND                                                             "Requested resolution of observed entity that is not loaded:  OBS_ENT_ID[{0}]"
        ...
        map.put(2139, SzConfigurationException.class);         // EAS_ERR_DSRC_INTEREST_CONFIGURED_WITH_INVALID_DSRCID                                  "Data Source Interest configured with invalid Data Source ID [{0}]"
        map.put(2205, SzConfigurationException.class);         // EAS_ERR_FTYPE_ID_DOES_NOT_EXIST                                                       "Feature type ID [{0}] does not exist."
        map.put(2206, SzConfigurationException.class);         // EAS_ERR_DATA_SOURCE_ID_DOES_NOT_MATCH                                                 "Data source ID [{0}] [{1}] does not match."
        ...
        map.put(3124, SzException.class);                      // EAS_ERR_JSON_DATA_IS_NULL                                                             "JSON record data cannot be null."
        map.put(3125, SzException.class);                      // EAS_ERR_JSON_RECORD_DATA_MUST_BE_OBJECT                                               "JSON record data must be an object, not an array."
        ...
        map.put(7219, SzException.class);                      // EAS_ERR_DB_TYPE_DOES_NOT_SUPPORT_EMBEDDING_DATA_TYPES                                 "Database type [{0}] does not support embedding data types"
        map.put(7220, SzConfigurationException.class);         // EAS_ERR_NO_CONFIG_REGISTERED_IN_DATASTORE                                             "No engine configuration registered in datastore"
        ...
        map.put(7239, SzConfigurationException.class);         // EAS_ERR_INVALID_GENERIC_THRESHOLD_CAP                                                 "Invalid generic threshold {0} cap [{1}] for [GPLAN_ID[{2}], BEHAVIOR[{3}], FTYPE_ID[{4}]]."
        ...
        map.put(8503, SzException.class);                      // EAS_ERR_SALT_DIGEST_CONTEXT_INIT_FAILED                                               "Failed {0} to initialize a digest context."
        ...
        map.put(8520, SzException.class);                      // EAS_ERR_SALT_SZSS_INIT_FAILED                                                         "Secure Store initialization failed."
        map.put(8521, SzException.class);                      // EAS_ERR_SALT_SZSS_TOKEN_MUST_BE_INIT                                                  "Hashing with a named salt requires the Secure Store to be initialized."
        map.put(8522, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_SOPIN_NOT_VALID                                                     "The Security Officer (SO) PIN is not correct."
        map.put(8524, SzException.class);                      // EAS_ERR_SALT_SZSS_INIT_UNKNOWN_EXCEPTION                                              "Secure Store initialization failed with an unrecognized exception"
        map.put(8525, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_REQUIRED_FOR_LOAD                                                   "Secure Store is required to load salt"
        map.put(8526, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_REQUIRED_FOR_GENERATE                                               "Secure Store is required to generate salt"
        map.put(8527, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_REQUIRED_FOR_IMPORT                                                 "Secure Store is required to import salt"
        map.put(8528, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_REQUIRED_FOR_EXPORT                                                 "Secure Store is required to export salt"
        map.put(8529, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_REQUIRED_FOR_DELETE                                                 "Secure Store is required to delete salt"
        map.put(8530, SzException.class);                      // EAS_ERR_SALT_CANNOT_OVERWRITE                                                         "You cannot overwrite an existing salt called {0}"
        map.put(8536, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_REQUIRED_FOR_LEGACY                                                 "Secure Store is required to add a legacy salt"
        map.put(8538, SzConfigurationException.class);         // EAS_ERR_SALT_SZSS_REQUIRED_FOR_METHOD                                                 "Secure Store is required to change hashing method"
        map.put(8539, SzException.class);                      // EAS_ERR_SALT_SZSS_ERROR_CHANGING_METHOD                                               "Secure Store error changing hashing method"
        ...
        map.put(8593, SzException.class);                      // EAS_ERR_SALT_HMAC_CONTEXT_INIT_FAILED                                                 "Failed {0} to initialize an HMAC context."
        ...
        map.put(9000, SzLicenseException.class);               // EAS_LIMIT_MAX_OBS_ENT                                                                 "LIMIT: Maximum number of records ingested: {0}. {1}"
        ...
        map.put(9225, SzConfigurationException.class);         // EAS_ERR_EMBEDDING_CANDIDATE_LICENSE_DISALLOWS                                         "Embedding FType [{0}] configured for candidates but not allowed by license."
        map.put(9226, SzBadInputException.class);              // EAS_ERR_FORCED_CANDIDATES_LICENSE_DISALLOWS                                           "Forced candidates are not allowed by license."
        map.put(9227, SzException.class);                      // EAS_ERR_FTYPE_CODE_INVALID_FOR_SQL                                                    "Feature type code [{0}] is invalid for use as SQL table name: {1}"
        ...
        map.put(9229, SzException.class);                      // EAS_ERR_SQLITE_VERSION_TOO_OLD                                                        "SQLite version {0} or higher is required (found {1}). RETURNING clause support is needed for efficient redo processing."
        ...
        map.put(9250, SzConfigurationException.class);         // EAS_ERR_SZSS_INVALID_LIB                                                              "Invalid ({1}) Secure Store plug-in library: {0}"
        map.put(9251, SzConfigurationException.class);         // EAS_ERR_SZSS_INVALID_URL                                                              "Invalid Secure Store URL: {0}"
        map.put(9252, SzConfigurationException.class);         // EAS_ERR_SZSS_INVALID_PIN                                                              "Invalid Secure Store credential specification: {0}"
        map.put(9253, SzConfigurationException.class);         // EAS_ERR_SZSS_TOKEN_INIT_FAILED                                                        "Secure Store token initialization failed: {0}."
        map.put(9254, SzConfigurationException.class);         // EAS_ERR_SZSS_TOKEN_UNINITIALIZED                                                      "Cannot open a Secure Store session when the token is uninitialized."
        map.put(9255, SzConfigurationException.class);         // EAS_ERR_SZSS_USER_PIN_UNINITIALIZED                                                   "Secure Store credential is uninitialized."
        map.put(9256, SzConfigurationException.class);         // EAS_ERR_SZSS_SESSION_OPEN                                                             "Cannot open a Secure Store session when one is already open."
        map.put(9257, SzConfigurationException.class);         // EAS_ERR_SZSS_NO_SESSION                                                               "Cannot use Secure Store without a session."
        map.put(9258, SzConfigurationException.class);         // EAS_ERR_SZSS_SESSION_OPEN_FAILED                                                      "Secure Store session could not be opened: {0}."
        map.put(9259, SzConfigurationException.class);         // EAS_ERR_SZSS_ADMIN_LOGIN_FAILED                                                       "Secure Store admin login failed: {0}."
        map.put(9260, SzConfigurationException.class);         // EAS_ERR_SZSS_USER_LOGIN_FAILED                                                        "Secure Store user login failed: {0}."
        map.put(9261, SzConfigurationException.class);         // EAS_ERR_SZSS_PKCS11_ERROR                                                             "Secure Store function failed: {0}"
        map.put(9264, SzConfigurationException.class);         // EAS_ERR_SZSS_LOGOUT_FAILED                                                            "Secure Store logout failed: {0}."
        map.put(9265, SzConfigurationException.class);         // EAS_ERR_SZSS_NEED_RW_SESSION                                                          "Secure Store session must be read/write."
        map.put(9266, SzConfigurationException.class);         // EAS_ERR_SZSS_UNABLE_TO_VERIFY_KEY                                                     "Secure Store key does not meet requirements."
        map.put(9267, SzException.class);                      // EAS_ERR_SZSS_UNABLE_TO_CREATE_KEY                                                     "Secure Store key creation failed."
        map.put(9268, SzException.class);                      // EAS_ERR_SZSS_UNABLE_TO_CHANGE_PIN                                                     "Secure Store password change failed: {0}."
        map.put(9269, SzConfigurationException.class);         // EAS_ERR_SZSS_INVALID_OLD_CREDENTIAL                                                   "Secure Store old credential is invalid."
        map.put(9270, SzConfigurationException.class);         // EAS_ERR_SZSS_INVALID_NEW_CREDENTIAL                                                   "Secure Store new credential is invalid."
        map.put(9271, SzException.class);                      // EAS_ERR_SZSS_OUT_OF_MEMORY                                                            "Secure Store out of memory."
        map.put(9272, SzException.class);                      // EAS_ERR_SZSS_FIND_INIT_FAILED                                                         "Secure Store object locating failed: {0}."
        map.put(9273, SzException.class);                      // EAS_ERR_SZSS_FIND_FAILED                                                              "Secure Store object find failed: {0}."
        map.put(9274, SzException.class);                      // EAS_ERR_SZSS_CRYPTO_SETUP_FAILED                                                      "Secure Store setup of encryption failed: {0}."
        map.put(9275, SzException.class);                      // EAS_ERR_SZSS_ENCRYPT_START_FAILED                                                     "Secure Store unable to start encryption: {0}."
        map.put(9276, SzException.class);                      // EAS_ERR_SZSS_ENCRYPT_SIZE_FAILED                                                      "Secure Store unable to get the size of encrypted data: {0}."
        map.put(9277, SzException.class);                      // EAS_ERR_SZSS_ENCRYPT_FAILED                                                           "Secure Store encryption failed: {0}."
        map.put(9278, SzException.class);                      // EAS_ERR_SZSS_DECRYPT_START_FAILED                                                     "Secure Store unable to start decryption: {0}."
        map.put(9279, SzException.class);                      // EAS_ERR_SZSS_DECRYPT_FAILED                                                           "Secure Store decryption failed: {0}."
        map.put(9280, SzException.class);                      // EAS_ERR_SZSS_OBJECT_SAVE_FAILED                                                       "Secure Store unable to save object: {0}."
        map.put(9281, SzException.class);                      // EAS_ERR_SZSS_OBJECT_DELETE_FAILED                                                     "Secure Store unable to delete object: {0}."
        map.put(9282, SzException.class);                      // EAS_ERR_SZSS_OBJECT_CHANGE_FAILED                                                     "Secure Store unable to modify object: {0}."
        map.put(9283, SzException.class);                      // EAS_ERR_SZSS_UNINITIALIZED                                                            "Secure Store has not been initialized"
        map.put(9284, SzConfigurationException.class);         // EAS_ERR_SZSS_INVALID_SLOT_ID                                                          "Can not obtain info on specified slot. Possibly invalid slot ID specified in Secure Store URL: {0}"
        map.put(9285, SzConfigurationException.class);         // EAS_ERR_SZSS_NO_TOKEN_IN_SLOT                                                         "No security token present in slot specified by Secure Store URL: slot ID = {0}"
        map.put(9286, SzConfigurationException.class);         // EAS_ERR_SZSS_TOKEN_NOT_FOUND                                                          "Can not obtain info for security token. Possibly invalid token label and/or slot ID specified in Secure Store URL: {0}"
        map.put(9287, SzException.class);                      // EAS_ERR_SZSS_TOKEN_IMPL_ERROR                                                         "An internal error occurred in the security token implementation library: Return Code = {0}"
        map.put(9288, SzException.class);                      // EAS_ERR_SZSS_USER_PIN_PROMPT_FAILED                                                   "Was unable to prompt user for security token authentication."
        map.put(9289, SzException.class);                      // EAS_ERR_SZSS_LABEL_CHANGED_SINCE_CONFIG_INIT                                          "Secure Store has been reconfigured since loading."
        map.put(9290, SzException.class);                      // EAS_ERR_SZSS_OBJECT_NOT_FOUND                                                         "Secure Store does not have an object called {0}."
        map.put(9292, SzConfigurationException.class);         // EAS_ERR_SZSS_NO_PASSWORD                                                              "No password supplied"
        map.put(9293, SzConfigurationException.class);         // EAS_ERR_SZSS_NO_SEC_STORE_PREFIX                                                      "Secure Store expects a different format (starting with {0}) when a password is supplied"
        map.put(9295, SzConfigurationException.class);         // EAS_ERR_SZSS_NO_DATA_OBJECTS                                                          "There are no Secure Store objects stored on the token"
        map.put(9296, SzConfigurationException.class);         // EAS_ERR_SZSS_SEC_STORE_ARCHIVE_BAD                                                    "The exported archive appears to be corrupted around object {0}"
        map.put(9297, SzConfigurationException.class);         // EAS_ERR_SZSS_FILE_NOT_FOUND                                                           "Secure Store failed to open {0}"
        map.put(9298, SzConfigurationException.class);         // EAS_ERR_SZSS_FILE_CONTENTS_BAD                                                        "Secure Store contents of {0} not usable."
        map.put(9299, SzException.class);                      // EAS_ERR_SZSS_CLASS_NOT_INIT                                                           "Secure Store internal error."
        map.put(9300, SzConfigurationException.class);         // EAS_ERR_SZSS_PASSWORD_CHECK_ERROR                                                     "Secure Store internal error ({0}) checking password."
        ...
        map.put(9406, SzException.class);                      // EAS_ERR_SZSS_SESSION_MUST_NOT_BE_OPEN                                                 "Secure Store cannot fetch a value with sync if a session is already open."
        map.put(9408, SzConfigurationException.class);         // EAS_ERR_SZSS_PASSWORD_INADEQUATE                                                      "The provided password is not strong enough: {0}"
        map.put(9409, SzConfigurationException.class);         // EAS_ERR_SZSS_FUNCTION_LIST_NOT_SET                                                    "The security token interface is not yet set"
        map.put(9410, SzException.class);                      // EAS_ERR_SZSS_PKCS_INIT_FAILED                                                         "Initializing token driver failed {0}"
        map.put(9411, SzException.class);                      // EAS_ERR_SZSS_PKCS_FINAL_FAILED                                                        "Finalizing token driver failed {0}"
        map.put(9413, SzConfigurationException.class);         // EAS_ERR_SZSS_INCORRECT_PASSWORD                                                       "The export file password appears to be incorrect."
        ...
        map.put(9804, SzException.class);                      // EAS_ERR_NULL_PARAMETER                                                                "Invalid null parameter [{1}] passed to function [{0}]"
        map.put(9805, SzException.class);                      // EAS_ERR_ADDRESS_INTERPRETER_NOT_INITIALIZED                                           "AddressInterpreter not initialized - initializeAI() must be called before primeAddressInterpreter()"
        map.put(9806, SzException.class);                      // EAS_ERR_GNR_RESOURCE_HANDLE_NOT_INITIALIZED                                           "GNRResourceHandle not initialized - primeGNRResources() must be called first"
        map.put(9807, SzException.class);                      // EAS_ERR_ADDRESS_INTERPRETER_INIT_FAILED                                               "AddressInterpreter initialization failed: {0}"
    }
}
